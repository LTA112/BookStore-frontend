...
function AddBook() {
    ...
    fetchCategories()
      .then((response) => {
        if (Array.isArray(response.data)) {
          setCategories(
            response.data.filter((category) => category.catStatus === 1)
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const isDuplicate = fetchedBooks.some(
  ...
  return (
    <div className="main-container">
      ...
      <div className="dashboard-content">
        <h1 className="titlemanagement">Add Book</h1>
        ...
        >
          <Form.Item
            ...
            ]} // Yêu cầu chọn ít nhất một category
            style={{ width: "100%" }}
          >
            <Select
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter the author" },
              {
                pattern: /^\p{L}+(\s\p{L}+)*$/u,
                message:
                  "Author name must contain letters, numbers, and cannot be only spaces",
              },
            ]}
          >
<<<<<<< HEAD
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter the dimensions" },
              {
                ...
                message:
                  'Dimensions must be in the format "number x number" (e.g., 25.5x26.3x27.1)',
              },
            ]}
          >
              ...
              { required: true, message: "Please enter the price" },
              {
                validator: (_, value) => {
                  ...
                  return Promise.reject(
                    new Error("Price must not exceed 100,000,000")
                  );
                },
              },
            ]}
          ...
          <Form.Item
            ...
            rules={[
              { required: false, message: "Please enter the translator" },
              {
                pattern: /^\p{L}+(\s\p{L}+)*$/u,
                message:
                  "Translator name must contain letters, numbers, and cannot be only spaces",
              },
            ]}
          >
<<<<<<< HEAD
            ...
            rules={[
              { required: true, message: "Please enter the hardcover" },
              {
                validator: (_, value) => {
                  ...
                  return Promise.reject(
                    new Error("Hardcover must not exceed 10,000")
                  );
                },
              },
            ]}
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter the publisher" },
              {
                pattern: /^\p{L}+(\s\p{L}+)*$/u,
                message:
                  "Publisher name must contain letters, numbers, and cannot be only spaces",
              },
            ]}
          >
            ...
            rules={[
              { required: true, message: "Please enter the weight" },
              {
                validator: (_, value) => {
                  ...
                  return Promise.reject(
                    new Error("Weight must not exceed 100,000 gram")
                  );
                },
              },
            ]}
